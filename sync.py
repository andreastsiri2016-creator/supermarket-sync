...
print("🚀 Εκκίνηση συγχρονισμού 43 εμπορικών προϊόντων με πραγματικές συσκευασίες...")
...
# 2. Πλήρης Κατάλογος 43 Εμπορικών Προϊόντων με Πραγματικές Συσκευασίες
products_catalog = [
    # Ελαιόλαδα & Λάδια
    ...
    # Καφέδες & Πρωινό
    {"barcode": "520101000004", "name": "Εσπρέσο Αλεσμένος Espresso Classico 250g", "category": "Καφέδες", "brand": "Jacobs", "unit": "250g", "image_url": "https://images.unsplash.com/photo-1559056199-641a0ac8b55e?w=500&auto=format&fit=crop"},
    {"barcode": "520101000024", "name": "Ελληνικός Καφές Παπαγάλος Παραδοσιακός 194g", "category": "Καφέδες", "brand": "Λουμίδης", "unit": "194g", "image_url": "https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?w=500&auto=format&fit=crop"},
    {"barcode": "520101000025", "name": "Καφές Φίλτρου Filter 250g", "category": "Καφέδες", "brand": "Jacobs Gold", "unit": "250g", "image_url": "https://images.unsplash.com/photo-1511920170033-f8396924c348?w=500&auto=format&fit=crop"},
    ...
    {"barcode": "520101000029", "name": "Φασόλια Μέτρια Ελληνικά 500g", "category": "Όσπρια & Ρύζια", "brand": "Agrino", "unit": "500g", "image_url": "https://www.komvosprom.gr/hexabit/img/eshop/product/21-01802-01.jpg"},
    ...
    {"barcode": "520101000015", "name": "Εμφιαλωμένο Νερό Φυσικό Μεταλλικό 6x1.5L", "category": "Αναψυκτικά & Χυμοί", "brand": "Ζαγόρι", "unit": "9L", "image_url": "https://images.unsplash.com/photo-1548839140-29a749e1bc4e?w=500&auto=format&fit=crop"},
    {"barcode": "520101000032", "name": "Coca-Cola Original Taste 4x500ml", "category": "Αναψυκτικά & Χυμοί", "brand": "Coca-Cola", "unit": "2L", "image_url": "https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=500&auto=format&fit=crop"},
    {"barcode": "520101000033", "name": "Μπίρα Lager Κουτί 6x330ml", "category": "Αναψυκτικά & Χυμοί", "brand": "Fix Hellas", "unit": "1.98L", "image_url": "https://images.unsplash.com/photo-1608270586620-248524c67de9?w=500&auto=format&fit=crop"},
    {"barcode": "520101000012", "name": "Μπισκότα Γεμιστά με Κρέμα Σοκολάτα 200g", "category": "Σνακ & Γλυκά", "brand": "Παπαδοπούλου", "unit": "200g", "image_url": "https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=500&auto=format&fit=crop"},
    {"barcode": "520101000034", "name": "Πατατάκια Αλάτι Lay's 150g", "category": "Σνακ & Γλυκά", "brand": "Lay's", "unit": "150g", "image_url": "https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=500&auto=format&fit=crop"},
    {"barcode": "520101000035", "name": "Σοκολάτα Υγείας Παυλίδη 100g", "category": "Σνακ & Γλυκά", "brand": "Παυλίδης", "unit": "100g", "image_url": "https://images.unsplash.com/photo-1582176647444-3e9146ec75aa?w=500&auto=format&fit=crop"},
    ...
    {"barcode": "520101000036", "name": "Απορρυπαντικό Πλυντηρίου Υγρό 40 μεζούρες", "category": "Χαρτικά & Καθαριστικά", "brand": "Ariel", "unit": "2L", "image_url": "https://images.unsplash.com/photo-1610557892470-55d9e80c0bce?w=500&auto=format&fit=crop"},
    ...
    {"barcode": "520101000014", "name": "Οδοντόκρεμα Colgate Total Clean Mint 75ml", "category": "Προσωπική Φροντίδα", "brand": "Colgate", "unit": "75ml", "image_url": "https://images.unsplash.com/photo-1559598467-f8b76c8155d0?w=500&auto=format&fit=crop"},
    ...
    {"barcode": "520101000041", "name": "Μωρομάντηλα Aqua Pure 99% Νερό 3x48 τμχ", "category": "Βρεφικά", "brand": "Pampers Aqua Pure", "unit": "144 τμχ", "image_url": "https://b.scdn.gr/images/sku_main_images/022879/22879812/xlarge_20200422145850_pampers_pure_aqua_18x48tmch.jpeg"},
    {"barcode": "520101000042", "name": "Πάνες Νο 4 (9-14kg) Monthly Pack", "category": "Βρεφικά", "brand": "Pampers Premium Care", "unit": "188 τμχ", "image_url": "https://www.ofarmakopoiosmou.gr/sites/default/files/styles/product_large/public/8006530223829_1_0.jpg?itok=Li0dIwxV"},
    {"barcode": "520101000043", "name": "Βρεφική Κρέμα Συγκάματος Sudocrem 125g", "category": "Βρεφικά", "brand": "Sudocrem", "unit": "125g", "image_url": "https://ncdn.nowpharmacy.gr/mediastream/w640/files/products/5d8e500de5ba8a5d3851f19da2d71529.jpg.webp"}
]
...
print("📦 Συγχρονισμός καταλόγου προϊόντων με ακριβή στοιχεία...")
...
print("🎉 Ο συγχρονισμός ολοκληρώθηκε 100% επιτυχώς με εμπορικές συσκευασίες!")
