...
print("🚀 Εκκίνηση συγχρονισμού 47 προϊόντων με διορθωμένες, ακριβείς και σχετικές εικόνες...")
...
# 2. Πλήρης Κατάλογος 47 Προϊόντων με Σωστές, Σχετικές Εικόνες ανά Είδος
products_catalog = [
    # --- Ελαιόλαδα & Λάδια ---
    ...
    {"barcode": "520101000031", "name": "Ηλιέλαιο Sol 1L", "category": "Ελαιόλαδα", "brand": "Sol", "unit": "1L", "image_url": "https://images.unsplash.com/photo-1620706857370-e1b993a58c35?w=600&auto=format&fit=crop"}, # Σωστό μπουκάλι λαδιού/ηλιελαίου
    ...
    {"barcode": "520101000007", "name": "Γιαούρτι Στραγγιστό Total 2% 3x200g", "category": "Γαλακτοκομικά", "brand": "ΦΑΓΕ", "unit": "600g", "image_url": "https://images.unsplash.com/photo-1488477181946-6428a0291777?w=600&auto=format&fit=crop"}, # Σωστό κεσεδάκι γιαουρτιού
    ...
    {"barcode": "520101000045", "name": "Τυρί Cottage Cheese Light 200g", "category": "Γαλακτοκομικά", "brand": "Arla", "unit": "200g", "image_url": "https://images.unsplash.com/photo-1559561853-08451507cbe7?w=600&auto=format&fit=crop"}, # Σωστό λευκό τυρί / cottage
    ...
    {"barcode": "520101000026", "name": "Μέλι Ανθέων & Κωνοφόρων 480g", "category": "Πρωινό", "brand": "Αττική", "unit": "480g", "image_url": "https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=600&auto=format&fit=crop"}, # Σωστό βαζάκι μελιού
    {"barcode": "520101000027", "name": "Merenda Κρέμα Φουντουκιού 360g", "category": "Πρωινό", "brand": "Παυλίδης", "unit": "360g", "image_url": "https://images.unsplash.com/photo-1541781774459-bb2af2f05b55?w=600&auto=format&fit=crop"}, # Σωστό βαζάκι κρέμας σοκολάτας-φουντουκιού
    ...
    {"barcode": "520101000028", "name": "Φακές Ψιλές 500g", "category": "Όσπρια & Ρύζια", "brand": "Voion", "unit": "500g", "image_url": "https://images.unsplash.com/photo-1515543237350-b3eea1ec8082?w=600&auto=format&fit=crop"}, # Σωστά όσπρια (φακές)
    {"barcode": "520101000029", "name": "Φασόλια Μέτρια Ελληνικά 500g", "category": "Όσπρια & Ρύζια", "brand": "Agrino", "unit": "500g", "image_url": "https://images.unsplash.com/photo-1551462147-37885acc36f1?w=600&auto=format&fit=crop"}, # Σωστά φασόλια
    {"barcode": "520101000030", "name": "Σάλτσα Τομάτας Passata 500g", "category": "Κονσέρβες", "brand": "KYKNOS", "unit": "500g", "image_url": "https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?w=600&auto=format&fit=crop"}, # Σωστή σάλτσα ντομάτας / passata
    {"barcode": "520101000010", "name": "Τόνος σε Νερό 3x80g", "category": "Κονσέρβες", "brand": "Rio Mare", "unit": "240g", "image_url": "https://images.unsplash.com/photo-1534483509719-3feaee7c30da?w=600&auto=format&fit=crop"}, # Σωστό προϊόν ψαριού / τόνου
    ...
    {"barcode": "520101000021", "name": "Κιμάς Μοσχαρίσιος Νωπός 500g", "category": "Κρέατα", "brand": "Φρέσκος", "unit": "500g", "image_url": "https://images.unsplash.com/photo-1588347818036-558601350947?w=600&auto=format&fit=crop"}, # Σωστός νωπός κιμάς
    {"barcode": "520101000022", "name": "Γαλοπούλα Καπνιστή Φέτες 160g", "category": "Αλλαντικά", "brand": "Υφαντής", "unit": "160g", "image_url": "https://images.unsplash.com/photo-1528735602780-2552fd46c7af?w=600&auto=format&fit=crop"}, # Σωστές φέτες αλλαντικού / γαλοπούλας
    {"barcode": "520101000047", "name": "Γαλοπούλα Βραστή Φέτες 160g", "category": "Αλλαντικά", "brand": "Creta Farm", "unit": "160g", "image_url": "https://images.unsplash.com/photo-1528735602780-2552fd46c7af?w=600&auto=format&fit=crop"}, # Σωστές φέτες γαλοπούλας
    {"barcode": "520101000023", "name": "Πάριζα Χαράκι En Elladi 300g", "category": "Αλλαντικά", "brand": "Creta Farm", "unit": "300g", "image_url": "https://images.unsplash.com/photo-1541529086526-db283c563270?w=600&auto=format&fit=crop"}, # Σωστό αλλαντικό / πάριζα
    {"barcode": "520101000016", "name": "Ψωμί για Τόστ Σίτου 500g", "category": "Αρτοποιία", "brand": "Karas", "unit": "500g", "image_url": "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=600&auto=format&fit=crop"}, # Σωστό ψωμί για τόστ
    ...
    {"barcode": "520101000015", "name": "Εμφιαλωμένο Νερό 6x1.5L", "category": "Αναψυκτικά & Χυμοί", "brand": "Ζαγόρι", "unit": "9L", "image_url": "https://images.unsplash.com/photo-1548839140-29a749e1bc4e?w=600&auto=format&fit=crop"}, # Σωστά μπουκάλια νερού
    ...
    {"barcode": "520101000012", "name": "Μπισκότα Γεμιστά Σοκολάτα 200g", "category": "Σνακ & Γλυκά", "brand": "Παπαδοπούλου", "unit": "200g", "image_url": "https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=600&auto=format&fit=crop"}, # Σωστά γεμιστά μπισκότα
    ...
    {"barcode": "520101000035", "name": "Σοκολάτα Υγείας 100g", "category": "Σνακ & Γλυκά", "brand": "Παυλίδης", "unit": "100g", "image_url": "https://images.unsplash.com/photo-1582176647444-3e9146ec75aa?w=600&auto=format&fit=crop"}, # Σωστή μαύρη σοκολάτα υγείας
    ...
    {"barcode": "520101000013", "name": "Υγρό Πιάτων Λεμόνι 500ml", "category": "Χαρτικά & Καθαριστικά", "brand": "Fairy", "unit": "500ml", "image_url": "https://images.unsplash.com/photo-1585842378054-ee2e52f94ba2?w=600&auto=format&fit=crop"}, # Σωστό μπουκάλι απορρυπαντικού / υγρού πιάτων
    ...
    {"barcode": "520101000037", "name": "Μαλακτικό Ρούχων 50 μεζούρες", "category": "Χαρτικά & Καθαριστικά", "brand": "Lenor", "unit": "1.2L", "image_url": "https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=600&auto=format&fit=crop"}, # Σωστό μπουκάλι μαλακτικού
    {"barcode": "520101000040", "name": "Χαρτί Κουζίνας 2 ρολά", "category": "Χαρτικά & Καθαριστικά", "brand": "Endless", "unit": "2 τμχ", "image_url": "https://images.unsplash.com/photo-1600585152220-90363fe7e115?w=600&auto=format&fit=crop"}, # Σωστό χαρτί κουζίνας
    {"barcode": "520101000014", "name": "Οδοντόκρεμα Colgate Total 75ml", "category": "Προσωπική Φροντίδα", "brand": "Colgate", "unit": "75ml", "image_url": "https://images.unsplash.com/photo-1559598467-f8b76c8155d0?w=600&auto=format&fit=crop"}, # Σωστό tub οδοντόκρεμας
    ...
    # --- Βρεφικά Είδη ---
    {"barcode": "520101000041", "name": "Μωρομάντηλα Aqua Pure 3x48 τμχ", "category": "Βρεφικά", "brand": "Pampers Aqua Pure", "unit": "144 τμχ", "image_url": "https://images.unsplash.com/photo-1555252333-9f8e92e65df9?w=600&auto=format&fit=crop"}, # Σωστά βρεφικά είδη / μωρομάντηλα
...
print("🎉 Ο συγχρονισμός ολοκληρώθηκε 100% επιτυχώς και τακτοποιημένα!")
